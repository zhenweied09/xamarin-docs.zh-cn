...
<h3><a name="EM0000"/>EM0000： 意外的错误-请填写在一个 bug 报告 https://github.com/mono/Embeddinator-4000/issues</h3>
...
<h3><a name="EM0099"/>EM0099： 内部错误 *。 请文件与测试用例的一个 bug 报告 (https://github.com/mono/Embeddinator-4000/issues)。</h3>
