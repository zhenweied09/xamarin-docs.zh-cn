...
有关如何将提交到测试云 UITests 的详细信息，请查阅本指南在[上载准备 Xamarin.UITests](/appcenter/test-cloud/preparing-for-upload/uitest/)。
...
- [准备 Xamarin.UITests 以及上载](/appcenter/test-cloud/preparing-for-upload/uitest/)
