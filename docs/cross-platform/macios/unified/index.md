...
- [更新现有的应用](updating-apps.md)
- [更新现有 iOS 应用程序](updating-ios-apps.md)
- [更新现有的 Mac 应用](updating-mac-apps.md)
- [更新现有 Xamarin.Forms 应用](updating-xamarin-forms-apps.md)
- [迁移到统一的 API 绑定](update-binding.md)

## <a name="tips-for-updating-code-to-the-unified-apiupdating-tipsmd"></a>[代码更新为统一的 API 的提示](updating-tips.md)
...
有关背景支持 32 和 64 位应用程序和有关框架的信息请参阅[32 位和 64 位平台注意事项](~/cross-platform/macios/32-and-64.md)。
