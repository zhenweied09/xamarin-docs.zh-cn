...
这些屏幕截图显示每个平台上可用的可视化屏幕设计器：
 ...
 [ ![](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png "这些屏幕截图显示每个平台上可用的可视化屏幕设计器")](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png)
