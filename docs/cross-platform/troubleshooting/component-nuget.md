---
title: 更新组件引用到 NuGet
description: 本文档介绍如何将你组件的引用替换 NuGet 程序包添加到将来证明你的应用，因为已停止使用 Xamarin 组件应用商店。
...
常用 Xamarin 列表[插件和库](https://github.com/xamarin/XamarinComponents/blob/master/README.md)可用于帮助查找组件不可为 NuGet 包的替代方法。
