...
崩溃报告下有**查看设备日志**按钮。 系统日志中的设备将出现在下泄露箭头的窗口底部<img alt="Disclosure arrow" src="https://kb.xamarin.com/customer/portal/attachments/382618" style="width: 15px; height: 12px;" />。
