...
我们将我们的文件将直接添加到根**内容**用于 iOS 和 Android 的文件夹。 为此，右键单击或按住 control 键单击上**内容**文件夹中的 iOS 项目并选择**添加** > **添加文件...**导航到其中我们前面解压缩内容，然后选择**paddle.png**。 如果系统询问有关如何将文件添加到文件夹，我们应选择**复制**选项：
...
现在我们可以运行游戏，并请参阅我们的游戏中，显示这增大如球退回从刀片中移出的分数：
