...
[![iOS 开发工作流](images/xma2.png)](images/xma2.png)
...
1. 打开 Spotlight (**⌘-Space**)，搜索“远程登录”，然后选择“共享”结果。 这将打开“共享”面板中的“系统首选项”：
   ...
   [![用于远程登录的 Spotlight 搜索](images/spotlight.png)](images/spotlight.png)

2. 在左侧的“服务”列表中勾选“远程登录”选项以允许适用于 Visual Studio 的 Xamarin 连接到 Mac：

   [![选中“服务”列表中的“远程登录”选项](images/sharing.png)](images/sharing.png)
...
[![旁边有“已连接”图标的“主机选择”对话框](images/image6.png)](images/image6.png)

在任意时刻只能有一个连接的 Mac。

右键单击列表中的每台计算机（无论是否连接）都会显示上下文菜单，允许根据需要选择“连接”、“断开连接”或“忘记此 Mac”：

[![“连接”、“断开连接”或“忘记此 Mac”上下文菜单](images/image7.png)](images/image7.png)
...
1. 在 Mac 上浏览到“系统首选项”>“共享”>“远程登录”，可找到你的 Mac IP 地址：
   ...
   [![“系统首选项”中的 Mac IP 地址](images/image8.png)](images/image8.png)

   或者，如果偏好使用命令行，可通过在终端中输入 `ipconfig getifaddr en0` 以找到你的 IP 地址（注意，根据不同的连接类型，变量可能为 `en1`、`en2` 等）：

   [![终端应用中的 IP 地址](images/image9.png)](images/image9.png)

2. 返回 Visual Studio，在“主机选择”对话框中，选择“添加 Mac...”：

   [![“主机选择”对话框](images/image10.png)](images/image10.png)

3. 在“添加 Mac”对话框中输入 Mac IP 地址，然后单击“添加”：

   [![将 Mac 的 IP 地址输入到“添加 Mac”对话框](images/image11.png)](images/image11.png)

4. 最后，输入 Mac 管理员帐户的用户名（不是全名）以及相应密码：

   [![输入用户名和密码](images/image12.png)](images/image12.png)
