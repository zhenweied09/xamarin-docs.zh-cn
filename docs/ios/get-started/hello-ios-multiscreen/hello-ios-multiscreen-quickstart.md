...
本部分演练将向 Phoneword 应用程序添加第二个屏幕，将显示使用该应用进行呼叫的电话号码历史记录。 最终的应用程序将拥有第二个屏幕，可显示呼叫历史记录，如下面的屏幕截图所示：
 ...
 [ ![](hello-ios-multiscreen-quickstart-images/00.png "最终的应用程序将拥有第二个屏幕，可显示呼叫历史记录，如此屏幕快照所示")](hello-ios-multiscreen-quickstart-images/00.png)
...
7. 在弹出窗口中，将关系设置为**根**：
  ...
  现在，“ViewController”是**导航控制器的根视图控制器。**
