---
title: 使用 Xamarin.iOS iCloud
description: 本文档介绍 iCloud 以及在 Xamarin.iOS 应用程序中的使用它。 它讨论键-值存储、 文档存储和 iCloud 备份。
ms.prod: xamarin
...
ms.locfileid: "34785532"
---
# <a name="using-icloud-with-xamarinios"></a>使用 Xamarin.iOS iCloud
