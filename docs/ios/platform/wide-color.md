---
title: 在 Xamarin.iOS 广泛的颜色
description: 本文档讨论了广泛的颜色和如何可以在 Xamarin.iOS 或 Xamarin.Mac 应用中使用它。 它还提供许多重要颜色相关概念，如颜色空间、 通道和主数据库的高级概述。
ms.prod: xamarin
...
ms.locfileid: "34788776"
---
# <a name="wide-color-in-xamarinios"></a>在 Xamarin.iOS 广泛的颜色
